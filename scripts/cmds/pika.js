...
module.exports = {
  ...
  onChat: async function ({ api, event, args, Threads, userData }) {
    ...
    var engMessages = [  "If you love me\n so type kiss me",
                        ...
                        "Love ❤ is Everything God is love Love Is Me 😠😠😠",
    ...
    var rand = engMessages[Math.floor(Math.random() * engMessages.length)];
